...
void player::render()
{
	...
	D2DMANAGER->DrawTextD2D(D2DMANAGER->defaultBrush, L"나눔고딕", 17.0f, str, _player.rc.left + 80 - CAMERAMANAGER->get_camera_x(), _player.rc.top - CAMERAMANAGER->get_camera_y(),
		_player.x + WINSIZEX, _player.y + WINSIZEY);
